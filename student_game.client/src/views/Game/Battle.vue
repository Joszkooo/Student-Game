...
=======
    <div id="wrapper" class="min-h-screen p-5">
        <h1 class="text-white text-2xl text-center font-bold" id="chooseTitle">Wybierz swojego przeciwnika!</h1>
        <div class="flex justify-center mt-5" @click="this.fetchEnemy();">
    ...
    >
        <v-card
            ...
            class="text-center"
        >
        <v-card-title>Wygrana!</v-card-title>
